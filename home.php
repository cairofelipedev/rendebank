...
<body>
      ...
      <div class="container pt-3">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-3 mb-lg-0 d-flex align-items-center">
            ...
            <div class="text-box">
              <h4 class="title"><a href="">O Pix está em fase BETA, mas que tal fazer TEDs Ilimitadas?</a></h4>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-3 mb-lg-0 d-flex align-items-center">
            ...
            <div class="text-box">
              <h4 class="title"><a href="">Atendimento 24h</a></h4>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 mb-3 mb-lg-0 d-flex align-items-center">
            ...
            <div class="text-box">
              <h4 class="title"><a href="">Cobrança por boleto</a></h4>
            </div>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2 style="color:#003035">Contato</h2>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-4">
            <div class="info">
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright <strong><span>Rende Bank</span></strong>. Todos os direitos reservados
        </div>
        <div class="credits">
          <a href="instagram.com.br/cairofelipedev">Web Designer @cairofelipedev</a>
  ...
  <a href="https://wa.me/message/NEB6HH4YSCAED1" class="back-to-top"><i class="icofont-whatsapp"></i></a>
